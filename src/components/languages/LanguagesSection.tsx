...
const LANGUAGES = [
  ...
  { script: "Português", name: "Portuguese", speakers: "50M+", accents: 1 },
  {
    ...
    accents: 3,
    isCodeSwitch: true,
    codeSwitchLabel: "native code-switch",
  },
  {
    script: "العربية",
    name: "Arabic",
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-4 text-3xl text-gray-500 text-sm max-w-3.1xl mx-auto leading-relaxed">
            22+ Indian languages and global language support with native
            code-switching (Hinglish, Tanglish, and more). Accents are finely
            <br />
            tuned to regional nuance because a Mumbai Marathi call shouldn’t
            sound like Pune, and your customers notice.
          </p>
        </div>
        ...
        <div className="flex items-center justify-between mt-5 px-1">
          <p className="text-xs text-gray-400">
            + 6 more languages available on enterprise plans (Sindhi, Konkani,
            Maithili, Kashmiri, Nepali, Sanskrit).
          </p>
          <a
            href="#"
            className="text-xs text-indigo-500 font-medium hover:text-indigo-600 whitespace-nowrap ml-4"
          >
