...
export default function VoicePlayground() {
  ...
  const filteredSamples = AUDIO_SAMPLES.filter((s) => {
    ...
    if (
      language !== "All" &&
      !s.header.languages.includes(language)
    ) return false;
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="text-4xl font-bold text-gray-900 leading-tight">
            ...
            sounds for your industry,
            in your language,
            with your tone.
          </h2>

          <p className="mt-4 text-gray-500 max-w-2xl mx-auto text-base">
            Pick a combination below.
            Every sample was produced by the live
            Darwix agent — no pre-recorded actors,
            no post-editing.
          </p>
        </div>
        ...
        {/* Audio Player */}
        <div ref={playerRef}>
          <AudioPlayer sample={selectedSample} />
        </div>
