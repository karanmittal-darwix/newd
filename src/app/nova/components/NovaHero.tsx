...
export default function NovaHero() {
  ...
  <span className="text-[#5b5ce8]">in lockstep.</span>
        ...
        <p className="mt-6 text-center text-[13px] sm:text-[15px] text-[#6e6e80] max-w-[640px] mx-auto leading-[1.75]">
          Where Sherpa is the field RM's wearable, Nova is the in-store AI concierge — a
          screen, a kiosk, a presence at the counter. Senses the customer. Understands
          their need. Acts and converts. Same brain. Different skin.
        </p>
