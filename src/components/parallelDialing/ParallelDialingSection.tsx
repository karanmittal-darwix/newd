    ...
    <section className="bg-gray-50 py-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-2xl md:text-5xl font-bold text-gray-900 tracking-tight leading-tight">
            Not one call. Ten thousand,
            <span className="text-indigo-600"> simultaneously.</span>
          </h2>
          <p className="mt-6 text-gray-500 text-lg max-w-3.5xl mx-auto leading-relaxed">
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-start">
          ...
          {/* Right: Live call stream */}
          <div className="flex-1 bg-indigo-50 border border-indigo-100 rounded-2xl ml-16 p-10">
              ...
              {LIVE_CALLS.map((call) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-1.5">
                    <span className={`w-1.5 h-1.5 rounded-full ${DOT_STYLES[call.status]}`} />
                    <span className={`text-xs font-semibold tracking-wide ${STATUS_STYLES[call.status]}`}>
                      {call.status}
                    </span>
                  </div>
                </div>
