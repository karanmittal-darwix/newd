...
const ACTION_TOKEN_SETS = [
	...
	["rm_summary_email", "next_step_owner", "hot_lead_context", "sentiment_resolved"],
	...
	["site_visit_24_apr", "calendar_invite_sent", "rm_availability", "branch_followup"],
						...
						<div className="rounded-[18px] border border-[#e4e4e8] bg-[#F8F8F8] p-5 sm:p-6 shadow-[0_6px_18px_rgba(46,55,88,0.08)]">
							...
							<div className="mt-5 space-y-2.5">
								{ACTION_EVENTS.map((event, index) => {
									...
									const isCompletedAction = activeActionIndex >= 0 && index < activeActionIndex;
									const isPendingAction = activeActionIndex >= 0 && index > activeActionIndex;
									...
									>
										<div className="flex items-start gap-3">
											<div className={`mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-md border ${isActiveAction ? "border-[#c8cdfa] bg-white" : isCompletedAction ? "border-[#bfe6cb] bg-white" : "border-[#d8d9df] bg-[#f7f7f8]"}`}>
